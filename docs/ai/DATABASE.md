...
Aucune base de données ni pilote JDBC n'est implémenté aux Tickets 001 à 007. La valeur `storage.type: sqlite` exprime uniquement le choix futur par défaut. Les métadonnées de cartes du Ticket 007 utilisent des YAML locaux et atomiques; elles ne constituent pas un stockage de statistiques ou de parties.
