  ...
  public ConfigurationSnapshot create(
    ...
    GameSettings gameSettings =
        new GameSettings(
            ...
            game.string("game.scoreboard.title-v7", "<aqua><bold>HENERIA</bold> <white>BEDWARS"),
            game.stringList(
                "game.scoreboard.waiting-v7.lines",
                List.of(
                    "",
                    "<gray>CARTE",
                    "<aqua>{arena_name}",
                    ...
                    "<white>Requis <dark_gray>› <yellow>{minimum_players}",
                    "<white>État <dark_gray>› {state_color}{state}",
                    "{status_message}",
                    "",
                    "<yellow>{server_address}"),
                15),
            game.stringList(
                "game.scoreboard.starting-v7.lines",
                List.of(
                    "",
                    "<gray>CARTE",
                    "<aqua>{arena_name}",
                    "",
                    "<white>Joueurs <dark_gray>› <green>{players}<gray>/{maximum_players}",
                    "<white>Début dans <dark_gray>› <green><bold>{countdown}s",
                    "",
                ...
                15),
            game.stringList(
                "game.scoreboard.playing-v7.lines",
                List.of(
                    "",
                    "<gray>CARTE <dark_gray>• <aqua>{arena_name}",
                    "",
                    "<white>Équipe <dark_gray>› {team_color}<bold>{team_name}",
                    "<white>Lit <dark_gray>› {bed_status}",
                    "<white>Équipes <dark_gray>› <green>{remaining_teams}",
                    "",
                    "<white>Éliminations <dark_gray>› <green>{kills}",
                    "<white>Lits détruits <dark_gray>› <aqua>{beds_destroyed}",
                    "",
                    "<yellow>{server_address}"),
                15),
